          ...
          <div className="row row-gallary">
            ...
            <div className="col-8">
              <div class="d-flex flex-wrap justify-content-center">
                <img className="px-2 py-2 pic pic1" alt="" />
                <img className="px-2 py-2 pic pic2 " alt="" />
                <img className="px-2 py-2 pic pic3 " alt="" />
                <img className="px-2 py-2 pic pic4" alt="" />
                <img className="px-2 py-2 pic pic5" alt="" />
                <img className="px-2 py-2 pic pic6" alt="" />
                <img
                  src="./assets/img/9.jpg"
                  className="px-2 py-2 pic pic7"
                  alt=""
                />
                <img
                  src="./assets/img/10.jpg"
                  className="px-2 py-2 pic pic8"
                  alt=""
                />
              </div>
            </div>
