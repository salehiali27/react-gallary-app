          ...
          <div className="row row-gallary">
            ...
            <div className="col-8">
              <div class="d-flex flex-wrap justify-content-center">
                <img className="px-2 py-2 pic ocean1" alt="" />
                <img className="px-2 py-2 pic ocean2" alt="" />
                <img className="px-2 py-2 pic ocean3" alt="" />
                <img className="px-2 py-2 pic ocean4" alt="" />
              </div>
            </div>
          </div>
        </div>
